...
public class JSONTest {
	...
	public void testFindResource() throws Exception {
		...
		try (InputStream expected = findResource(JSONTest.TEST_FORMS, Thread.currentThread().getContextClassLoader())) {
			try (InputStream actual = JSON.findResource(JSONTest.TEST_FORMS, null)) {
