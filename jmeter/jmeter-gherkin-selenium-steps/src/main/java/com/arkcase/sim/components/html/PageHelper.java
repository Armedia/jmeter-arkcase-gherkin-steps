...
public class PageHelper extends AngularHelper {
	...
	public final Alert waitForAlertToBePresent(Timeout timeout, String message) {
		timeout = WebDriverHelper.getOrDefault(timeout, PageHelper.DEFAULT_TIMEOUT);
		message = WebDriverHelper.getOrDefault(message, "Alert is not present");
